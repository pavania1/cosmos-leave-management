...
// 	lmskeeper "github.com/pavania1/cosmos-leave-management/x/lms/keeper"
// 	lmstypes "github.com/pavania1/cosmos-leave-management/x/lms/types"

// 	lms "github.com/pavania1/cosmos-leave-management/x/lms/module"
...
// 	app.LmsKeeper = lmskeeper.NewKeeper(appCodec, keys[lmstypes.StoreKey])
...
// 		lms.NewAppModule(appCodec, app.LmsKeeper),
...
func NewSimApp(
	...
	*/
	...
	app.LmsKeeper = lmskeeper.NewKeeper(appCodec, keys[lmstypes.StoreKey]) // Register the proposal types
	// Deprecated: Avoid adding new handlers, instead use the new proposal flow
	// by granting the governance module the right to execute the message.
	// See: https://github.com/cosmos/cosmos-sdk/blob/release/v0.46.x/x/gov/spec/01_concepts.md#proposal-messages
	govRouter := govv1beta1.NewRouter()
	...
	*/
	...
	app.mm.SetOrderBeginBlockers(
		...
		authtypes.ModuleName, banktypes.ModuleName, govtypes.ModuleName, crisistypes.ModuleName, genutiltypes.ModuleName,
		authz.ModuleName, feegrant.ModuleName, nft.ModuleName, group.ModuleName,
		paramstypes.ModuleName, vestingtypes.ModuleName, lmstypes.ModuleName, ibchost.ModuleName,
